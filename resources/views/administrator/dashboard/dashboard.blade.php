                        ...
                        <td>
                            <section>
                                @if(count(ImageLabel::where('filename', $file->filename_post_iva)->get()) != 0)
                                    @if(count(ImageLabel::where('filename', $file->filename_post_iva)->get()) == 1 && ImageLabel::where('filename', $file->filename_post_iva)->first()->label == ImageUpload::IMAGE_NOT_LABELED_CODE)
